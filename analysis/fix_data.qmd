...
baltimore_concentration = baltimore_concentration.with_columns(
    pl.col("Date").str.to_date(r"%m/%d/%Y"),
)
baltimore_uncertainty = baltimore_uncertainty.with_columns(
    pl.col("Date").str.to_date(r"%m/%d/%Y"),
)
```
...
baltimore_concentration.columns = [
    col.lower().replace(' ', '_') 
    for col in baltimore_concentration.columns
]

baltimore_uncertainty.columns = [
    col.lower().replace(' ', '_') 
    for col in baltimore_uncertainty.columns
]
```
...
baltimore_concentration.with_columns(
    cs.numeric().round(5)
).glimpse()
```
...
(
    pl.concat([
        baltimore_concentration.head(5),
        baltimore_concentration.tail(5)
    ])
    .style
...
# convert the Date column to a proper date
baton_rouge_concentration = baton_rouge_concentration.with_columns(
    pl.col("Date").str.to_datetime(r"%m/%d/%Y %H:%M"),
)
baton_rouge_uncertainty = baton_rouge_uncertainty.with_columns(
    pl.col("Date").str.to_datetime(r"%m/%d/%Y %H:%M"),
)
```
...
baton_rouge_concentration.columns = [
    col.lower().replace(' ', '_') 
    for col in baton_rouge_concentration.columns
]

baton_rouge_uncertainty.columns = [
    col.lower().replace(' ', '_') 
    for col in baton_rouge_uncertainty.columns
]
```
...
baton_rouge_concentration.with_columns(
    cs.numeric().round(5)
).glimpse()
```
...
(
    pl.concat([
        baton_rouge_concentration.head(5),
        baton_rouge_concentration.tail(5)
    ])
    .style
    .fmt_datetime(
        columns="date",
...
# convert the Date column to a proper date
st_louis_concentration = st_louis_concentration .with_columns(
    pl.col("Date").str.to_datetime(r"%m/%d/%Y %H:%M"),
)
st_louis_uncertainty = st_louis_uncertainty.with_columns(
    pl.col("Date").str.to_datetime(r"%m/%d/%Y %H:%M"),
)
```
...
st_louis_concentration = st_louis_concentration.rename(col_name_map)
st_louis_uncertainty = st_louis_uncertainty.rename(col_name_map)
```
...
st_louis_concentration.with_columns(
    cs.numeric().round(5)
).glimpse()
```
...
(
    pl.concat([
        st_louis_concentration.head(5),
        st_louis_concentration.tail(5)
    ])
    .style
    .fmt_datetime(
        columns="date",
...
def write_long_data(
    ...
    combined = combined.with_columns(
        ...
        .otherwise(None)
        .alias("uncertainty_ratio_raw"),
        pl.col("concentration")
        .log1p()
        .alias("concentration_log")
    )
...
baltimore_concentration.with_columns(
    ...
    here("data/wide/log/baltimore_concentration_log.csv")
)
baltimore_uncertainty.with_columns(
    cs.numeric()
    .log1p()
    .round(6)
).write_csv(
    here("data/wide/log/baltimore_uncertainty_log.csv")
)
...
baton_rouge_concentration.with_columns(
    ...
    here("data/wide/log/baton_rouge_concentration_log.csv")
)
baton_rouge_uncertainty.with_columns(
    cs.numeric()
    .log1p()
    .round(6)
).write_csv(
    here("data/wide/log/baton_rouge_uncertainty_log.csv")
)
...
st_louis_concentration.with_columns(
    ...
    here("data/wide/log/st_louis_concentration_log.csv")
)
st_louis_uncertainty.with_columns(
    cs.numeric()
    .log1p()
    .round(6)
).write_csv(
    here("data/wide/log/st_louis_uncertainty_log.csv")
)
```

```{python}
#| label: write-wide-data-raw
#| eval: false
...
baltimore_concentration.with_columns(
    ...
    here("data/wide/raw/baltimore_concentration_raw.csv")
)
baltimore_uncertainty.with_columns(
    cs.numeric()
    .round(6)
).write_csv(
    here("data/wide/raw/baltimore_uncertainty_raw.csv")
)
...
baton_rouge_concentration.with_columns(
    ...
    here("data/wide/raw/baton_rouge_concentration_raw.csv")
)
baton_rouge_uncertainty.with_columns(
    cs.numeric()
    .round(6)
).write_csv(
    here("data/wide/raw/baton_rouge_uncertainty_raw.csv")
)
...
st_louis_concentration.with_columns(
    ...
    here("data/wide/raw/st_louis_concentration_raw.csv")
)
st_louis_uncertainty.with_columns(
    cs.numeric()
    .round(6)
).write_csv(
    here("data/wide/raw/st_louis_uncertainty_raw.csv")
)
```
