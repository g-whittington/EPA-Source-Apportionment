...
baltimore_concentration_log.write_csv(
    here("data/wide/baltimore_concentration.csv")
)
baltimore_uncertainty_log.write_parquet(
    here("data/wide/baltimore_uncertainty.parquet")
)

baton_rouge_concentration_log.write_csv(
    here("data/wide/baton_rouge_concentration.csv")
)
baton_rouge_uncertainty_log.write_parquet(
    here("data/wide/baton_rouge_uncertainty.parquet")
)

st_louis_concentration_log.write_csv(
    here("data/wide/st_louis_concentration.csv")
)
st_louis_uncertainty_log.write_parquet(
    here("data/wide/st_louis_uncertainty.parquet")
)
```
